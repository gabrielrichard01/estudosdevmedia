...
console.log(dataAtual.toLocaleTimeString('pt-BR', persolizandoTempo));
...
console.log(dataAtual.toLocaleDateString('pt-BR', personalizandoData2));
// segunda-feira, 09/11/20

const persolizandoTempo2 = {
    hour: 'numeric', // 01
    minute: 'numeric', // 05
    second: 'numeric', // 09
}
console.log(dataAtual.toLocaleTimeString('pt-BR', persolizandoTempo2));
// 01:05:09
...
console.log(dataAtual.toLocaleString('pt-BR', personalizandoDataTempo2));
